...
/* remember compilig math.h with gcc requires '-lm' */
 ...
 * @array: pointer to first element of array to sreach
 * @size: number of elements in a array
 * @value: value to search for
 *
 * Return: first index containing 'value', or -1if 'value' not found
 * or 'array' is NULL
 */
